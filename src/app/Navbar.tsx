    ...
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-4 px-4 pointer-events-none">
      ...
      >
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <span className="font-bold text-lg text-slate-900">Workflow</span>
        </div>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <Link
            ...
            className="border border-slate-900 text-slate-900 px-5 py-2 rounded-full text-sm font-medium hover:bg-slate-50 transition-colors whitespace-nowrap"
          >
            Discover Events
          </Link>
        </div>
